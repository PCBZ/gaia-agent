...
SYSTEM_PROMPT = (
    ...
    "- You are autonomous: never ask the user for clarification or more context — no "
    "one can reply, so a question is a failed answer. If a search returns nothing, "
    "retry with different terms or use jina_search, then commit to your best answer.\n"
